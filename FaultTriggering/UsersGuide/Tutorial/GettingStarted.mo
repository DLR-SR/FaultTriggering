...
<p>All Variable Faults are controlled by a global <a href=\"modelica://FaultTriggering.FaultOutput.FaultTrigger\">model</a> &quot;broadcasting&quot; the faults. Each variable fault therefore must be coupled to a fault channel from the global FaultTriggering model. This makes also external triggering of the faults (e.g. from Simulink) possible.</p>
<p><br/>Using these fault models all commonly know faults can be modelled. In <a href=\"modelica://FaultTriggering.UsersGuide.Tutorial.FaultModelling\">Fault Modelling</a> is explained how to use these blocks.</p>
